...
- БД: PostgreSQL (существующая) + новые колонки.
- ИЛИ: Графовая БД (Neo4j) + новые свойства узлов.

**Тестирование:**
- Юнит-тесты: поле VoI может быть null, вычисляться, обновляться.
- Интеграционные тесты: создание Решения с новыми полями и без них.
- Тесты миграций: существующие решения продолжают работать.
...
**Технологический стек:**
- Графовая БД: Neo4j (если используется) или реляционная с внешними ключами.
- Язык запросов: Cypher (Neo4j) или SQL.
